  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="w-full flex items-center">
        <span className="h-full font-normal text-center text-gray-400 bg-transparent rounded text-base justify-center w-8 pl-3 py-2 flex items-center">
        ...
        <input
          ...
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative bg-white border-none pl-3 text-base outline-none w-full"
